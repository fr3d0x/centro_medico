class AppointmentReportPdf < Prawn::Document
	def initialize(appointment_report)
		...
		move_down(10)
		text "Medico que prescribe: #{@appointment_report.appointment.doctor.nombre + ' ' + @appointment_report.appointment.doctor.apellido}", :size => 15, :style => :bold, :align => :center
		move_down(35)
		text "Telefono del doctor: #{@appointment_report.appointment.doctor.telefono1}"

		move_down(10)
		text "Paciente: #{@appointment_report.appointment.patient.nombre + ' ' + @appointment_report.appointment.patient.apellido}"
		move_down(10)
