...
class TablesControllerTest < ActionController::TestCase
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post :create, table: { tab_descripcion: @table.tab_descripcion, tab_nemonico: @table.tab_nemonico, tab_nombre: @table.tab_nombre }
    end
  ...
  test "should update table" do
    patch :update, id: @table, table: { tab_descripcion: @table.tab_descripcion, tab_nemonico: @table.tab_nemonico, tab_nombre: @table.tab_nombre }
    assert_redirected_to table_path(assigns(:table))
  end
